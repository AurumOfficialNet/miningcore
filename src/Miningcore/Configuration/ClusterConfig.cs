...
public class ClusterCoinConfig
{
    /// <summary>
    /// Coin identifier — must match the pool's "coin" field.
    /// </summary>
    public string Type { get; set; }
    ...
    /// <summary>
    /// Absolute path to a richlist.json file generated by the node.
    /// Expected format: [{"address": "...", "amount": 0.0}, ...]
    /// Used by the /api/network/{poolId}/top100 endpoint.
    /// </summary>
    public string RichListPath { get; set; }
}
...
public partial class ClusterConfig
{
    ...
    /// <summary>
    /// Inline coin definitions. Each entry's "type" must match a pool's "coin" field.
    /// </summary>
    public ClusterCoinConfig[] Coins { get; set; }
